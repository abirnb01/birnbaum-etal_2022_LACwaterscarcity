...
#update scenario names for df2 (create columns for tax, ssp, ag, soc)
def scen_columns(df):
# turn scenario into columns for different important dimensions

    df[['var1','var2','var3','tax']] = df['scenario'].str.split('_',n=3,expand=True)
...
if not isdir:
    os.mkdir(newpath+query+'_unlimited')
