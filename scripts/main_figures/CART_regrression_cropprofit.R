...
for (bs in basin_list) {
	...
	df_regr <- subset(no_dups, select = c("soc","ag","osf","tax","gw","esm","res","profit_pchange"))
...
write.csv(sum_importances,
          paste0("C:/Users/abirnb01/Documents/Research/NEXO-UA/LACwaterscarcity/data/CART_results/regr_cropprofit.csv"))
